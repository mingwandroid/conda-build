        ...
        try:
            ...
            if ldd_failed:
                ...
                if set(res[f]) != set(res_py):
                    print("WARNING: pyldd disagrees with ldd/otool. This will not cause any problems for this build,")
                    print("WARNING: But please file a bug at https://github.com/conda/conda-build")
                    print("WARNING: and (if possible) attach file {}".format(path))
                    print("WARNING: ldd/tool gives {}, pyldd gives {}".format(set(res[f]), set(res_py)))
