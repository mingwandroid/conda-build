...
def _patch_attributes_debug(pa, rel_path, build_prefix):
    ...
    pa_args_short_paths = copy(pa['args'])
    _i_index = pa_args_short_paths.index('-i')
    pa_args_short_paths[_i_index + 1] = os.path.basename(pa_args_short_paths[_i_index + 1])
    return "[[ {:>71} ]] - [[ {}{}{}{}{}{}{}{}{}{} ]] - [[ ... {:>20} {} ]]".format(
        rel_path[-71:],
        ...
        pa['patch_exe'][-20:], ' '.join(pa_args_short_paths))
    ...
    if patch:
        ...
        with noop_context(retained_tmpdir) if retained_tmpdir else TemporaryDirectory() as tmpdir:
            ...
            for fmt, _ in fmts.items():
                ...
                if fmt == 'native':
                    shutil.copyfile(path, new_patch, follow_symlinks=False)
                elif fmt == 'lf':
